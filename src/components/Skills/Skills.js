...
const Skills = () => {
	return (
		<div className="py-10 px-10 bg-[#0B1224]">
			<h1 className="text-center my-skills-header text-5xl capitalize text-[#64C59A] font-medium">
				My Skills
			</h1>

			<div className="skill-details mt-[100px] grid grid-cols-6 gap-5">
				<div className="text-[#64C59A] text-center h-[200px] skill hover:scale-105 transition-transform duration-300  w-[200px] rounded-md bg-[#11192e] ">
