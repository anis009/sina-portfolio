...
const Skills = () => {
	return (
		<div className="py-10 px-10 bg-[#0B1224]" id="skills">
			<h1 className="text-center my-skills-header text-5xl capitalize text-[#64C59A] font-medium">
				My Skills
			</h1>

			<div className="skill-details  mt-[100px] grid lg:grid-cols-6 md:grid-cols-4 sm:grid-cols-3 grid-cols-2 gap-5">
				<div className="text-[#64C59A]  h-[200px] text-center skill hover:scale-105 transition-transform duration-300  max-w-[200px] rounded-md bg-[#11192e] ">
					<FaJsSquare className="w-12 h-12 mx-auto rounded-md"></FaJsSquare>
					<h5 className="text-gray-200 text-sm pt-2">Javascript</h5>
				</div>
				<div className="text-[#64C59A] text-center h-[200px] skill hover:scale-105 transition-transform duration-300  max-w-[200px] rounded-md bg-[#11192e] ">
				...
				<div className="text-[#64C59A] text-center h-[200px] skill hover:scale-105 transition-transform duration-300  max-w-[200px] rounded-md bg-[#11192e] ">
					...
					<h5 className="text-gray-200 text-sm pt-2">Tailwind</h5>
				</div>
				<div className="text-[#64C59A] text-center h-[200px] skill hover:scale-105 transition-transform duration-300  max-w-[200px] rounded-md bg-[#11192e] ">
